...
#
# Generated by export_simulation on Tue Jul 22 14:14:10 +0330 2025
#
################################################################################
...
'-reset_run' switch to the './CA_LAB1.sh' script.

./CA_LAB1.sh -reset_run
...
./CA_LAB1.sh -noclean_files

For more information on the script, please type './CA_LAB1.sh -help'.
