...
HD_PWD='C:/aidin/AIDIN/peregrine/term-6/gh_CaLab/CA_LAB/Vivado/V3/CA_LAB/CA_LAB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CA_LAB1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CA_LAB1_wrapper.tcl
