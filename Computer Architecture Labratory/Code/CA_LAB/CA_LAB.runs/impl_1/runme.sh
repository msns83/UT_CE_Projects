...
HD_PWD='C:/aidin/AIDIN/peregrine/term-6/gh_CaLab/CA_LAB/Vivado/V3/CA_LAB/CA_LAB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CA_LAB1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CA_LAB1_wrapper.tcl -notrace
