...
extern int sys_rt_fork(void);
extern int sys_set_class(void);
extern int sys_ps(void);
extern int sys_barber_sleep(void);
extern int sys_customer_arrive(void);
extern int sys_cut_hair(void);
extern int sys_customer_wait_haircut(void);
extern int sys_open_shared_mem(void);
extern int sys_close_shared_mem(void);
extern int sys_monitor_init(void);
extern int sys_monitor_increase_all(void);
extern int sys_monitor_read(void);
extern int sys_monitor_close(void);
...
// LAB 3
[SYS_rt_fork] sys_rt_fork,
[SYS_set_class] sys_set_class,
[SYS_ps] sys_ps,
// Lab 4
[SYS_barber_sleep]     sys_barber_sleep,
[SYS_customer_arrive]  sys_customer_arrive,  
[SYS_cut_hair]        sys_cut_hair,
[SYS_customer_wait_haircut] sys_customer_wait_haircut,
// Lab 5
[SYS_open_shared_mem]      sys_open_shared_mem,
[SYS_close_shared_mem]     sys_close_shared_mem,
[SYS_monitor_init]         sys_monitor_init,
[SYS_monitor_increase_all] sys_monitor_increase_all,
[SYS_monitor_read]         sys_monitor_read,
[SYS_monitor_close]        sys_monitor_close,
};
