...
_incr_sync:     file format elf32-i386
...
main(void) {
   ...
   d:	53                   	push   %ebx
   e:	51                   	push   %ecx
   f:	81 ec 00 10 00 00    	sub    $0x1000,%esp
  15:	83 0c 24 00          	orl    $0x0,(%esp)
  if(monitor_init(ID, PGSIZE, 0) < 0){
  19:	83 ec 04             	sub    $0x4,%esp
  1c:	6a 00                	push   $0x0
  1e:	68 00 10 00 00       	push   $0x1000
  23:	6a 01                	push   $0x1
  25:	e8 e9 03 00 00       	call   413 <monitor_init>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	0f 88 81 00 00 00    	js     b6 <main+0xb6>
    printf(1, "monitor_init failed\n");
    exit();
  }
  if(fork() == 0){
  35:	e8 e1 02 00 00       	call   31b <fork>
  3a:	bb e8 03 00 00       	mov    $0x3e8,%ebx
  3f:	85 c0                	test   %eax,%eax
  41:	75 1d                	jne    60 <main+0x60>
  43:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    for(int i = 0; i < NITER; i++){
      monitor_increase_all(ID);
  48:	83 ec 0c             	sub    $0xc,%esp
  4b:	6a 01                	push   $0x1
  4d:	e8 c9 03 00 00       	call   41b <monitor_increase_all>
    for(int i = 0; i < NITER; i++){
  ...
  58:	75 ee                	jne    48 <main+0x48>
    ...
    exit();
  5a:	e8 c4 02 00 00       	call   323 <exit>
  5f:	90                   	nop
  }
  for(int i = 0; i < NITER; i++){
    monitor_increase_all(ID);
  ...
  63:	6a 01                	push   $0x1
  65:	e8 b1 03 00 00       	call   41b <monitor_increase_all>
  for(int i = 0; i < NITER; i++){
  ...
  wait();
  72:	e8 b4 02 00 00       	call   32b <wait>

  int buf[PGSIZE/sizeof(int)];
  if(monitor_read(ID, buf) < 0){
  77:	8d 85 f8 ef ff ff    	lea    -0x1008(%ebp),%eax
  7d:	52                   	push   %edx
  7e:	52                   	push   %edx
  7f:	50                   	push   %eax
  80:	6a 01                	push   $0x1
  82:	e8 9c 03 00 00       	call   423 <monitor_read>
  87:	83 c4 10             	add    $0x10,%esp
  8a:	85 c0                	test   %eax,%eax
  8c:	78 3b                	js     c9 <main+0xc9>
    printf(1, "monitor_read failed\n");
    exit();
  }
  printf(1, "sync   final = %d (expected %d)\n", buf[0], 2*NITER);
  8e:	68 d0 07 00 00       	push   $0x7d0
  93:	ff b5 f8 ef ff ff    	push   -0x1008(%ebp)
  99:	68 1c 08 00 00       	push   $0x81c
  9e:	6a 01                	push   $0x1
  a0:	e8 3b 04 00 00       	call   4e0 <printf>
  monitor_close(ID);
  a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ac:	e8 7a 03 00 00       	call   42b <monitor_close>
  exit();
  b1:	e8 6d 02 00 00       	call   323 <exit>
    printf(1, "monitor_init failed\n");
  b6:	51                   	push   %ecx
  b7:	51                   	push   %ecx
  b8:	68 e8 07 00 00       	push   $0x7e8
  bd:	6a 01                	push   $0x1
  bf:	e8 1c 04 00 00       	call   4e0 <printf>
    exit();
  c4:	e8 5a 02 00 00       	call   323 <exit>
    printf(1, "monitor_read failed\n");
  c9:	50                   	push   %eax
  ca:	50                   	push   %eax
  cb:	68 fd 07 00 00       	push   $0x7fd
  d0:	6a 01                	push   $0x1
  d2:	e8 09 04 00 00       	call   4e0 <printf>
    exit();
  d7:	e8 47 02 00 00       	call   323 <exit>
  dc:	66 90                	xchg   %ax,%ax
  de:	66 90                	xchg   %ax,%ax
...
000003d3 <set_sleep>:
SYSCALL(set_sleep)
 3d3:	b8 1b 00 00 00       	mov    $0x1b,%eax
 3d8:	cd 40                	int    $0x40
 3da:	c3                   	ret

000003db <getcmostime>:
SYSCALL(getcmostime)
 3db:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3e0:	cd 40                	int    $0x40
 3e2:	c3                   	ret

000003e3 <next_palindrome>:
SYSCALL(next_palindrome)
 3e3:	b8 1d 00 00 00       	mov    $0x1d,%eax
 3e8:	cd 40                	int    $0x40
 3ea:	c3                   	ret

000003eb <rt_fork>:
SYSCALL(rt_fork)
 3eb:	b8 1e 00 00 00       	mov    $0x1e,%eax
 3f0:	cd 40                	int    $0x40
 3f2:	c3                   	ret

000003f3 <set_class>:
SYSCALL(set_class)
 3f3:	b8 1f 00 00 00       	mov    $0x1f,%eax
 3f8:	cd 40                	int    $0x40
 3fa:	c3                   	ret

000003fb <ps>:
SYSCALL(ps)
 3fb:	b8 20 00 00 00       	mov    $0x20,%eax
 400:	cd 40                	int    $0x40
 402:	c3                   	ret

00000403 <open_shared_mem>:
SYSCALL(open_shared_mem)
 403:	b8 25 00 00 00       	mov    $0x25,%eax
 408:	cd 40                	int    $0x40
 40a:	c3                   	ret

0000040b <close_shared_mem>:
SYSCALL(close_shared_mem)
 40b:	b8 26 00 00 00       	mov    $0x26,%eax
 410:	cd 40                	int    $0x40
 412:	c3                   	ret

00000413 <monitor_init>:
SYSCALL(monitor_init)
 413:	b8 27 00 00 00       	mov    $0x27,%eax
 418:	cd 40                	int    $0x40
 41a:	c3                   	ret

0000041b <monitor_increase_all>:
SYSCALL(monitor_increase_all)
 41b:	b8 28 00 00 00       	mov    $0x28,%eax
 420:	cd 40                	int    $0x40
 422:	c3                   	ret

00000423 <monitor_read>:
SYSCALL(monitor_read)
 423:	b8 29 00 00 00       	mov    $0x29,%eax
 428:	cd 40                	int    $0x40
 42a:	c3                   	ret

0000042b <monitor_close>:
 42b:	b8 2a 00 00 00       	mov    $0x2a,%eax
 430:	cd 40                	int    $0x40
 432:	c3                   	ret
 ...
 448:	89 d1                	mov    %edx,%ecx
{
 ...
 47b:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
 ...
 4b6:	50                   	push   %eax
 4b7:	56                   	push   %esi
 4b8:	e8 86 fe ff ff       	call   343 <write>
  while(--i >= 0)
 ...
 4e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 520:	50                   	push   %eax
 521:	57                   	push   %edi
 522:	e8 1c fe ff ff       	call   343 <write>
 ...
 554:	ff 24 85 40 08 00 00 	jmp    *0x840(,%eax,4)
 ...
 591:	52                   	push   %edx
 592:	57                   	push   %edi
 593:	e8 ab fd ff ff       	call   343 <write>
        putc(fd, c);
 ...
 63a:	52                   	push   %edx
 63b:	57                   	push   %edi
 63c:	e8 02 fd ff ff       	call   343 <write>
        ap++;
 ...
 660:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 665:	bb 12 08 00 00       	mov    $0x812,%ebx
 ...
 671:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 6af:	5b                   	pop    %ebx
  freep = p;
 6b0:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 6b7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 38 0b 00 00    	mov    0xb38,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74b:	3b 05 38 0b 00 00    	cmp    0xb38,%eax
 751:	75 ed                	jne    740 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 753:	83 ec 0c             	sub    $0xc,%esp
 756:	56                   	push   %esi
 757:	e8 4f fc ff ff       	call   3ab <sbrk>
  if(p == (char*)-1)
 ...
 76e:	e8 fd fe ff ff       	call   670 <free>
  return freep;
 773:	8b 15 38 0b 00 00    	mov    0xb38,%edx
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 79f:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	b8 3c 0b 00 00       	mov    $0xb3c,%eax
    base.s.ptr = freep = prevp = &base;
