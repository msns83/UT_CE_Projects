...
_customer:     file format elf32-i386
...
int main(int argc, char *argv[]) {
   ...
   f:	e8 3f 03 00 00       	call   353 <getpid>
  ...
  26:	e8 a8 03 00 00       	call   3d3 <customer_arrive>
    
    if(result < 0) {
  2b:	83 c4 10             	add    $0x10,%esp
  2e:	85 c0                	test   %eax,%eax
  30:	78 40                	js     72 <main+0x72>
  ...
  40:	e8 9e 03 00 00       	call   3e3 <customer_wait_haircut>
  45:	83 c4 10             	add    $0x10,%esp
  48:	85 c0                	test   %eax,%eax
  4a:	78 13                	js     5f <main+0x5f>
  ...
  5f:	52                   	push   %edx
  60:	53                   	push   %ebx
  61:	68 28 08 00 00       	push   $0x828
  66:	6a 01                	push   $0x1
  68:	e8 33 04 00 00       	call   4a0 <printf>
        exit();
  6d:	e8 61 02 00 00       	call   2d3 <exit>
        printf(1, "Customer %d: Barbershop full, going home\n", customer_id);
  72:	51                   	push   %ecx
  73:	53                   	push   %ebx
  74:	68 d0 07 00 00       	push   $0x7d0
  79:	6a 01                	push   $0x1
  7b:	e8 20 04 00 00       	call   4a0 <printf>
        exit();
...
000003a3 <getcmostime>:
SYSCALL(getcmostime)
 3a3:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret

000003ab <next_palindrome>:
 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 dc 08 00 00 	movzbl 0x8dc(%edx),%edx
 ...
 476:	50                   	push   %eax
 477:	56                   	push   %esi
 478:	e8 76 fe ff ff       	call   2f3 <write>
  while(--i >= 0)
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4e0:	50                   	push   %eax
 4e1:	57                   	push   %edi
 4e2:	e8 0c fe ff ff       	call   2f3 <write>
 ...
 514:	ff 24 85 84 08 00 00 	jmp    *0x884(,%eax,4)
 ...
 551:	52                   	push   %edx
 552:	57                   	push   %edi
 553:	e8 9b fd ff ff       	call   2f3 <write>
        putc(fd, c);
 ...
 5fa:	52                   	push   %edx
 5fb:	57                   	push   %edi
 5fc:	e8 f2 fc ff ff       	call   2f3 <write>
        ap++;
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb 7d 08 00 00       	mov    $0x87d,%ebx
...
free(void *ap)
{
 ...
 631:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 7c 0b 00 00       	mov    %eax,0xb7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 7c 0b 00 00    	cmp    0xb7c,%eax
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 7c 0b 00 00 80 	movl   $0xb80,0xb7c
 777:	0b 00 00 
    base.s.size = 0;
 77a:	b8 80 0b 00 00       	mov    $0xb80,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 80 0b 00 00 80 	movl   $0xb80,0xb80
 786:	0b 00 00 
    base.s.size = 0;
 789:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 790:	00 00 00 
    if(p->s.size >= nunits){
