...
_barber:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        ...
        if(cut_hair() < 0) {
  28:	e8 ae 03 00 00       	call   3db <cut_hair>
  2d:	85 c0                	test   %eax,%eax
  2f:	78 40                	js     71 <main+0x71>
  ...
  34:	68 18 08 00 00       	push   $0x818
  39:	6a 01                	push   $0x1
  3b:	e8 60 04 00 00       	call   4a0 <printf>
        if(barber_sleep() < 0) {
  40:	83 c4 10             	add    $0x10,%esp
  43:	e8 83 03 00 00       	call   3cb <barber_sleep>
  48:	85 c0                	test   %eax,%eax
  4a:	79 dc                	jns    28 <main+0x28>
            printf(1, "Barber: Error sleeping\n");
  4c:	52                   	push   %edx
  4d:	52                   	push   %edx
  4e:	68 c3 07 00 00       	push   $0x7c3
  53:	6a 01                	push   $0x1
  ...
  67:	e8 34 04 00 00       	call   4a0 <printf>
    exit();
  6c:	e8 62 02 00 00       	call   2d3 <exit>
            printf(1, "Barber: Error cutting hair\n");
  71:	50                   	push   %eax
  72:	50                   	push   %eax
 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 514:	ff 24 85 3c 08 00 00 	jmp    *0x83c(,%eax,4)
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb 10 08 00 00       	mov    $0x810,%ebx
...
free(void *ap)
{
 ...
 631:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 30 0b 00 00    	mov    0xb30,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 30 0b 00 00    	cmp    0xb30,%eax
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 777:	0b 00 00 
    base.s.size = 0;
 77a:	b8 34 0b 00 00       	mov    $0xb34,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 786:	0b 00 00 
    base.s.size = 0;
 789:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 790:	00 00 00 
    if(p->s.size >= nunits){
