...
public class ActorDec extends Declaration {
    ...
    private SymbolTable constructorSymbolTable ;

    public SymbolTable getConstructorSymbolTable() {return constructorSymbolTable;}
    public void setConstructorSymbolTable(SymbolTable symbolTable) { constructorSymbolTable = symbolTable;}
    ...
    public ArrayList<Statement> getConstructorBody() {
