// Generated from /Users/majidsadeghinejad/Desktop/UT/SEM5/PLC/CA/phase-4-plc_ca_bamahdi/src/main/grammar/SOACT.g4 by ANTLR 4.13.2
package parsers;
		...
		try {
			...
			case SELF:
				...
				_localctx.assignRet.setLine((((AssignStatementContext)_localctx).SELF!=null?((AssignStatementContext)_localctx).SELF.getLine():0));
				                                                 _localctx.assignRet.addIdentifier(Identifier.createId("self" ,(((AssignStatementContext)_localctx).id2!=null?((AssignStatementContext)_localctx).id2.getLine():0)));
	...
	public final ObserveStatementContext observeStatement() throws RecognitionException {
		...
		try {
			...
			if(line == -1)
			                     ...
			                     _localctx.observeRet.addId(Identifier.createId((((ObserveStatementContext)_localctx).id!=null?((ObserveStatementContext)_localctx).id.getText():null), (((ObserveStatementContext)_localctx).id1!=null?((ObserveStatementContext)_localctx).id1.getLine():0)));
			setState(591);
			match(LPAR);
			setState(595);
			_errHandler.sync(this);
