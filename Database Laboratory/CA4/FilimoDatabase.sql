CREATE DATABASE  IF NOT EXISTS `filimo` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `filimo`;
...
CREATE TABLE `account` (
  ...
  KEY `sub_id` (`sub_id`),
  CONSTRAINT `account_ibfk_1` FOREIGN KEY (`sub_id`) REFERENCES `subscriptionplan` (`sub_id`) ON DELETE SET DEFAULT ON UPDATE CASCADE
...
CREATE TABLE `cinematic` (
  ...
  `fid` int NOT NULL,
  PRIMARY KEY (`fid`),
  CONSTRAINT `cinematic_ibfk_1` FOREIGN KEY (`fid`) REFERENCES `film` (`fid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `cinematic` WRITE;
/*!40000 ALTER TABLE `cinematic` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cinematic` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `comment` (
  ...
  KEY `uid` (`uid`),
  KEY `fid` (`fid`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `wuser` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`fid`) REFERENCES `film` (`fid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `commentreaction` (
  ...
  KEY `comm_id` (`comm_id`),
  CONSTRAINT `commentreaction_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `wuser` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `commentreaction_ibfk_2` FOREIGN KEY (`comm_id`) REFERENCES `comment` (`comm_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `participation` (
  ...
  KEY `cid` (`cid`),
  CONSTRAINT `participation_ibfk_1` FOREIGN KEY (`fid`) REFERENCES `film` (`fid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `participation_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `crew` (`cid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `season` (
  ...
  PRIMARY KEY (`sea_id`),
  KEY `fid` (`fid`),
  CONSTRAINT `season_ibfk_1` FOREIGN KEY (`fid`) REFERENCES `series` (`fid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `series` (
  ...
  `fid` int NOT NULL,
  PRIMARY KEY (`fid`),
  CONSTRAINT `series_ibfk_1` FOREIGN KEY (`fid`) REFERENCES `film` (`fid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video` (
  `vid` int NOT NULL,
  `create_at` date DEFAULT NULL,
  `is_dubbed` tinyint(1) DEFAULT NULL,
  `is_subtitled` tinyint(1) DEFAULT NULL,
  ...
  KEY `cin_id` (`cin_id`),
  KEY `sea_id` (`sea_id`),
  CONSTRAINT `video_ibfk_1` FOREIGN KEY (`cin_id`) REFERENCES `cinematic` (`fid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `video_ibfk_2` FOREIGN KEY (`sea_id`) REFERENCES `season` (`sea_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `videoreaction` (
  ...
  PRIMARY KEY (`uid`,`vid`),
  KEY `vid` (`vid`),
  CONSTRAINT `videoreaction_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `wuser` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `videoreaction_ibfk_2` FOREIGN KEY (`vid`) REFERENCES `video` (`vid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `watchhistoryitem` (
  ...
  PRIMARY KEY (`uid`,`fid`),
  KEY `fid` (`fid`),
  CONSTRAINT `watchhistoryitem_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `wuser` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `watchhistoryitem_ibfk_2` FOREIGN KEY (`fid`) REFERENCES `film` (`fid`) ON DELETE SET DEFAULT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `watchhistoryitem` WRITE;
/*!40000 ALTER TABLE `watchhistoryitem` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `watchhistoryitem` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `watchlistitem` (
  ...
  PRIMARY KEY (`uid`,`fid`),
  KEY `fid` (`fid`),
  CONSTRAINT `watchlistitem_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `wuser` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `watchlistitem_ibfk_2` FOREIGN KEY (`fid`) REFERENCES `film` (`fid`) ON DELETE SET DEFAULT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `watchlistitem` WRITE;
/*!40000 ALTER TABLE `watchlistitem` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `watchlistitem` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `wuser` (
  ...
  KEY `aid` (`aid`),
  CONSTRAINT `wuser_ibfk_1` FOREIGN KEY (`aid`) REFERENCES `account` (`aid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
